<footer class="footer">
    ...
    <div id="copyright">© 2021 <a href="mailto:adam.antal@student.spseke.sk" id="mail">Apply</a><a href="mailto:tomas.timko@student.spseke.sk" id="mail">For™</a>. All rights reserved.</div>
</footer>